...
RUN export TZ=Europe/Rome && \
	...
	apt-get -y install --no-install-recommends gnupg sqv dirmngr && \
	...
	apt-get -y apt-get -o Acquire::AllowInsecureRepositories=true install mono-complete && \
	apt-get -y --purge remove gnupg sqv dirmngr && \
